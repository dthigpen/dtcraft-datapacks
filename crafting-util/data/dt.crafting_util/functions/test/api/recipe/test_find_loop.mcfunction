...
function dt.crafting_util:test/internal/recipe/test_find_generic
...
execute if data storage call_stack: this.temp_recipes[0] run function dt.crafting_util:test/internal/recipe/test_find_loop
