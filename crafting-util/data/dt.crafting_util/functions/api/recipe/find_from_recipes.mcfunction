...
execute unless data storage call_stack: this.result.id if data storage call_stack: this.recipes[0] run function dt.crafting_util:internal/recipe/find_recipe_loop
