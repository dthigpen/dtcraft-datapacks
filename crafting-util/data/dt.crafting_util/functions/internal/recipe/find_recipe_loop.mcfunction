...
execute if data storage call_stack: {this:{is_match:true}} if data storage call_stack: {this:{has_tags:true}} if data storage call_stack: this.remaining_item_counts[0] run function dt.crafting_util:internal/recipe/resolve_tags
...
execute if data storage call_stack: this.temp_recipes[0] if data storage call_stack: {this:{found_recipe:false}} run function dt.crafting_util:internal/recipe/find_recipe_loop
