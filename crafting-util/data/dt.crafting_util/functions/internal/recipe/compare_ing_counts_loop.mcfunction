...
function dt.crafting_util:is_matching_item
...
execute if score result dt.tmp = #equal dt.enum if score size1 dt.tmp matches 1.. if score size2 dt.tmp matches 1.. run function dt.crafting_util:internal/recipe/compare_ing_counts_loop
