...
data modify storage call_stack: this.result.items set from storage call_stack: this.items_in_group
data modify storage call_stack: this.result.tag set from storage call_stack: this.tag
...
execute if data storage call_stack: this.items_in_group[0] run data modify storage call_stack: this.result set from storage call_stack: call.result
