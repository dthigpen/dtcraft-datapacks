...
execute if data storage call_stack: this.tags[0] if data storage call_stack: this.item_counts[0] run function dt.crafting_util:internal/recipe/resolve_tags_item_loop
