...
execute if data storage call_stack: {this:{id_count_match:1}} if data storage call_stack: this.matches[0].slots run function dt.array_util:api/split_by_key
...
execute if data storage call_stack: {this:{fail_early:false}} unless data storage call_stack: this.ingredients[0] run function dt.array_util:api/concat
