...
execute if data storage call_stack: this.items[0] if data storage call_stack: this.group_values[0] run function dt.crafting_util:internal/group/filter_items_in_group_loop
