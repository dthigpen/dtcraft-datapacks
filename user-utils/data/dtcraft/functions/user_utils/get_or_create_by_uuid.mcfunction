...
execute if data storage dtcraft:call_stack this.users[0] unless data storage dtcraft:call_stack this.user.UUID run data modify storage dtcraft:call_stack call.arg0 set from storage dtcraft:call_stack this.arg0
