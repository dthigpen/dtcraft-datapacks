...
execute if score result dt.tmp = #not_found dt.enum run data modify storage dtcraft:tmp arg1 set from storage dtcraft:user_utils uuid
execute if score result dt.tmp = #not_found dt.enum run function dtcraft:user_utils/create_by_uuid
