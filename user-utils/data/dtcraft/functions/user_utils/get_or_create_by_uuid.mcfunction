...
execute if data storage dtcraft:call_stack this.users[0] run data modify storage dtcraft:call_stack this.user set from storage dtcraft:call_stack call.result
...
execute unless data storage dtcraft:call_stack this.user.UUID run data modify storage dtcraft:call_stack this.user set from storage dtcraft:call_stack call.result
