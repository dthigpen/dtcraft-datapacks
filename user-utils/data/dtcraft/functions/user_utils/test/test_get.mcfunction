...
# get
data modify storage dtcraft:call_stack this.test_name set value "get"
...
data modify storage dtcraft:call_stack this.test_user2 set from storage dtcraft:call_stack this.calls[0].value
