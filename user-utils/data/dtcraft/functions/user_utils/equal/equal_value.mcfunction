...
execute if score result dt.tmp = #equal dt.enum run data modify storage dtcraft:call_stack this.result set value true
execute if score result dt.tmp = #not_equal dt.enum run data modify storage dtcraft:call_stack this.result set value false
