...
data modify storage dtcraft:call_stack this.other_users set from storage dtcraft:call_stack this.call.result
data modify storage dtcraft:call_stack this.other_users prepend from storage dtcraft:call_stack this.user

data modify storage dtcraft:call_stack this.result set from storage dtcraft:call_stack this.other_users
