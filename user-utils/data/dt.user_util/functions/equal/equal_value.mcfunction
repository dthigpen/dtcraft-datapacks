...
execute if score result dt.tmp = #equal dt.enum run data modify storage call_stack: this.return set value true
execute if score result dt.tmp = #not_equal dt.enum run data modify storage call_stack: this.return set value false
