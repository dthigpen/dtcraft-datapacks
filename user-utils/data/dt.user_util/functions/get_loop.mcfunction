...
execute if data storage call_stack: {this:{equal:true}} run data modify storage call_stack: this.return set from storage call_stack: this.users[0]
...
execute if data storage call_stack: {this:{equal:false}} if data storage call_stack: this.users[0] run data modify storage call_stack: this.return set from storage call_stack: call.return
#endregion
