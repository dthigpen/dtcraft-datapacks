...
execute unless data storage unittest:internal {temp:{result:{pass:true}}} run tellraw @s ["    ",{"text":"Fail: ","color":"dark_red"},{"nbt":"temp.result.msg","storage":"unittest:internal", "interpret": true}]
