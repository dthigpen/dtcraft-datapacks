...
data modify storage dtcraft:call_stack this.hotbar set from storage dtcraft:call_stack this.calls[0].value
...
data modify storage dtcraft:call_stack this.feathers set from storage dtcraft:call_stack this.calls[0].value

scoreboard players set result dt.tmp 0
execute if data storage dtcraft:call_stack this.feathers[{Slot:2b, id:"minecraft:feather"}] if data storage dtcraft:call_stack this.feathers[{Slot:6b, id:"minecraft:feather"}] run scoreboard players set result dt.tmp 1
#todo check for size
