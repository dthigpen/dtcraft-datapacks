...
data modify storage dtcraft:call_stack this.inventory set from storage dtcraft:call_stack this.calls[0].value
...
data modify storage dtcraft:call_stack this.found_item set from storage dtcraft:call_stack this.calls[0].value
scoreboard players set result dt.tmp 0
execute if data storage dtcraft:call_stack this.found_item{Slot:26b, id:"minecraft:feather"} run scoreboard players set result dt.tmp 1
