...
execute unless data storage call_stack: this.do_trim run data modify storage call_stack: this.result set from storage call_stack: this.array
...
execute if data storage call_stack: this.do_trim run data modify storage call_stack: this.result set from storage call_stack: call.result
