#> dt.array:api/funct/reducer/to/bool/true/push
...
execute unless data storage call_stack: this.accumulator run data modify storage call_stack: this.accumulator set value true
