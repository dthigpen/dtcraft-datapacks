#> dt.array:api/func/_template/base_case/some_condition
...
execute unless data storage call_stack: this.continue run data modify storage call_stack: this.return set from storage call_stack: this.func._template.other_thing