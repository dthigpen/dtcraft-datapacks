...
# execute store result storage call_stack: this.result int 1 run scoreboard players get $int1 dt.tmp

execute if score $int1 dt.tmp >= $int2 dt.tmp run data modify storage call_stack: this.result set from storage call_stack: this.arg0
execute if score $int2 dt.tmp > $int1 dt.tmp run data modify storage call_stack: this.result set from storage call_stack: this.arg1
