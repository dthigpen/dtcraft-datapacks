...
execute if data storage call_stack: {this:{is_split:true}} run data modify storage call_stack: this.result set value []
execute if data storage call_stack: {this:{is_split:true}} run data modify storage call_stack: this.result append from storage call_stack: this.first_half
execute if data storage call_stack: {this:{is_split:true}} run data modify storage call_stack: this.result append from storage call_stack: this.remaining
...
execute if data storage call_stack: {this:{is_split:false}} run data modify storage call_stack: this.result set from storage call_stack: call.result
