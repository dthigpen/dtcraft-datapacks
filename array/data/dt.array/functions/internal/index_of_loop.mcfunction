...
# base-case
execute unless data storage call_stack: this.array[0] run data modify storage call_stack: this.result set value -1
...
# case 1a
execute if data storage call_stack: {this:{unequal:false}} run data modify storage call_stack: this.result set from storage call_stack: this.index
...
execute if data storage call_stack: {this:{unequal:true}} run data modify storage call_stack: this.result set from storage call_stack: call.result
