...
execute unless data storage call_stack: this.continue run data modify storage call_stack: this.result[0] set from storage call_stack: this.with_key
execute unless data storage call_stack: this.continue run data modify storage call_stack: this.result[1] set from storage call_stack: this.without_key
