...
execute run data modify storage call_stack: this.array1 set from storage call_stack: call.result[0]
execute run data modify storage call_stack: this.array2 set from storage call_stack: call.result[1]
...
execute if data storage call_stack: this.array1[1] run data modify storage call_stack: this.array1 set from storage call_stack: call.result
...
execute if data storage call_stack: this.array2[1] run data modify storage call_stack: this.array2 set from storage call_stack: call.result
