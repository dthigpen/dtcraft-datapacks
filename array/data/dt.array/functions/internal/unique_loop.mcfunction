...
execute unless data storage call_stack: this.continue run data modify storage call_stack: this.result set from storage call_stack: this.unique
...
execute if data storage call_stack: this.continue run data modify storage call_stack: this.index set from storage call_stack: call.result
