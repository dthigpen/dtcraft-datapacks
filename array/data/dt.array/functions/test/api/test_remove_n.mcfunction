...
data modify storage call_stack: this.test_name set value "remove_n_empty_list"
...
function call_stack:push
data modify storage call_stack: this.test_name set value "remove_n_remove_0"
...
function call_stack:push
data modify storage call_stack: this.test_name set value "remove_n_remove_2"
data modify storage call_stack: this.array set value [1,2,3]
...
function call_stack:push
data modify storage call_stack: this.test_name set value "remove_n_remove_extra"
data modify storage call_stack: this.array set value [1,2,3]
data modify storage call_stack: this.expected set value []
