...
data modify storage call_stack: this.item_to_insert set value {Slot:99b,id:"minecraft:slime_ball",Count:1b}
...
data modify storage call_stack: call.arg0 set from storage call_stack: this.item_to_insert
execute positioned 2999999 250 2999999 run function dt.inventory:api/loot_to_block
