...
execute at @p positioned ~ 255 ~ run setblock ~ ~ ~ chest replace
execute at @p positioned ~ 255 ~ run function dt.inventory:api/items/loot/block/insert
...
execute at @p positioned ~ 255 ~ run data modify storage call_stack: call.actual set from block ~ ~ ~ Items
