...
function dt.inventory:internal/arrays/get_first_by_id
...
execute if data storage call_stack: this.found_item{Slot:2b, id:"minecraft:feather"} run scoreboard players set result dt.tmp 1
