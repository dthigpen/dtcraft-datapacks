#> dt.inventory:api/items/summon2
...
function dt.inventory:api/item/summon2
...
execute if data storage call_stack: this.items[-1] run function dt.inventory:api/items/summon2 
