...
# Offhand and armor
execute if score $int1 dt.tmp matches -106 run loot replace entity @s weapon.offhand 1 mine 2999999 255 2999999 stick{drop_contents:true}
execute if score $int1 dt.tmp matches 100 run loot replace entity @s armor.feet 1 mine 2999999 255 2999999 stick{drop_contents:true}
execute if score $int1 dt.tmp matches 101 run loot replace entity @s armor.legs 1 mine 2999999 255 2999999 stick{drop_contents:true}
execute if score $int1 dt.tmp matches 102 run loot replace entity @s armor.chest 1 mine 2999999 255 2999999 stick{drop_contents:true}
execute if score $int1 dt.tmp matches 103 run loot replace entity @s armor.head 1 mine 2999999 255 2999999 stick{drop_contents:true}
