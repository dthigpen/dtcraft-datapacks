...
execute if data storage call_stack: this.remaining_items[0] run data modify storage call_stack: this.index set from storage call_stack: call.result
...
# base-case
execute unless data storage call_stack: this.remaining_items[0] run data modify storage call_stack: this.result set from storage call_stack: this.processed_items
