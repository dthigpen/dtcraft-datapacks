...
data modify storage dtcraft:inv_sort remaining_items set from storage dtcraft:tmp result
#endregion

#region get user hotbar
function dtcraft:inventory_utils/get_hotbar
data modify storage dtcraft:inv_sort hotbar_items set from storage dtcraft:tmp result
#endregion
