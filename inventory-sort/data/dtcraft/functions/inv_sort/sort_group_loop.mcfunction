...
execute if data storage dtcraft:call_stack this.remaining_items[0] run data modify storage dtcraft:call_stack this.sorted_items set from storage dtcraft:call_stack this.call.result.sorted_items
execute if data storage dtcraft:call_stack this.remaining_items[0] run data modify storage dtcraft:call_stack this.new_remaining_items set from storage dtcraft:call_stack this.call.result.new_remaining_items
...
execute if data storage dtcraft:call_stack this.group_values[0] run data modify storage dtcraft:call_stack this.result set from storage dtcraft:call_stack this.call.result
