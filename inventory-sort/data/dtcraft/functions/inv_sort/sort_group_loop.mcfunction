...
execute unless data storage dtcraft:call_stack this.group_values[0] run scoreboard players set int1 dt.tmp 1
execute unless data storage dtcraft:call_stack this.remaining_items[0] run scoreboard players set int1 dt.tmp 1

execute if score int1 dt.tmp matches 1 run data modify storage dtcraft:call_stack this.result set value {remaining_items:[], sorted_items:[]}
...
# loop
execute if score int1 dt.tmp matches 0 run data modify storage dtcraft:call_stack call.arg0 set from storage dtcraft:call_stack this.group_values
...
execute if score int1 dt.tmp matches 0 run function dtcraft:inv_sort/sort_group_loop
