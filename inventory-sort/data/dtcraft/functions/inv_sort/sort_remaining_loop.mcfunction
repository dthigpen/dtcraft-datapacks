...
execute store success storage dtcraft:call_stack this.not_equal byte 1 run data modify storage dtcraft:call_stack this.value1 set from storage dtcraft:call_stack this.temp_remaining_items[0].id
...
execute if data storage dtcraft:call_stack {this:{not_equal:true}} run data modify storage dtcraft:call_stack this.new_remaining_items append from storage dtcraft:call_stack this.temp_remaining_items[0]
...
execute if data storage dtcraft:call_stack this.temp_remaining_items[0] run data modify storage dtcraft:call_stack this.result set from storage dtcraft:call_stack call.result
