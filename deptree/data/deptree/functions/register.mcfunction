...
execute unless data storage deptree: temp.started run data modify storage deptree: temp.new_pack_deps set from storage deptree: info.dependencies
...
execute if data storage deptree: temp.new_pack_deps[0] unless data storage deptree: temp.loaded_packs[0] run tellraw @p ["",{"text":"Error loading: ","color":"red"},{"nbt":"info.name","storage":"deptree:", "bold":false}]
...
execute if data storage deptree: {temp:{equal_version:true}} unless data storage deptree: temp.new_pack_deps[0] run tellraw @p ["",{"text":"Loaded datapack: ","color":"green"},{"nbt":"info.name","storage":"deptree:"}]
execute if data storage deptree: {temp:{equal_version:true}} unless data storage deptree: temp.new_pack_deps[0] run data modify storage deptree: datapacks append from storage deptree: info
