...
data modify storage call_stack: this.result_items set value [{id:"minecraft:redstone_block", Count:1b}]
...
execute run data modify storage call_stack: call.arg0 set from storage call_stack: this.result_items
execute run data modify storage call_stack: call.arg1 set from storage call_stack: this.tagged_items
execute run function dt.autocraft:internal/blocks/autocrafter/copy_tag_slots
execute run data modify storage call_stack: this.actual set from storage call_stack: call.result
...
data modify storage call_stack: this.result_items set value [{id:"minecraft:honey_block", Count:1b},{id:"minecraft:glass_bottle", Count:6b}]
data modify storage call_stack: this.tagged_items set value [{id:"minecraft:slime", Count:1b, Slot:2b}]
...
data modify storage call_stack: this.result_items set value [{id:"minecraft:honey_block", Count:1b}]
