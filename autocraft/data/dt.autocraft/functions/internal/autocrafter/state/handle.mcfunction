...
execute if score #has_last_result dt.tmp matches 1 unless score #block_result_item dt.tmp matches 1 run function dt.autocraft:internal/autocrafter/crafting/find_and_replace_placeholder
execute unless score #has_last_result dt.tmp matches 1 unless score #block_result_item dt.tmp matches 1 run function dt.autocraft:internal/autocrafter/crafting/create_result_placeholder
execute if score #has_last_result dt.tmp matches 1 if score #block_result_placeholder dt.tmp matches 1 run function dt.autocraft:internal/autocrafter/crafting/changed_placeholder
