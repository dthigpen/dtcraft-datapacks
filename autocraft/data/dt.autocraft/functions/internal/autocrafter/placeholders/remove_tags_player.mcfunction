...
data modify storage call_stack: this.placeholders set from storage call_stack: call.return[0]
...
execute if data storage call_stack: this.placeholders[0] run function dt.autocraft:internal/autocrafter/placeholders/remove_player_tags_loop
