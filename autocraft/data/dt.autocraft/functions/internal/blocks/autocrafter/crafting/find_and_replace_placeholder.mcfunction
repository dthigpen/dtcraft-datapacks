...
execute if data storage call_stack: this.autocrafter_data.state_data.ingredients run function dt.autocraft:internal/blocks/autocrafter/crafting/set_ingredients
...
function dt.autocraft:internal/blocks/autocrafter/crafting/create_result_placeholder
