...
#>body
data modify storage call_stack: this.return_items[0].Slot set from storage call_stack: this.tagged_items[0].Slot
data modify storage call_stack: this.slotted_items append from storage call_stack: this.return_items[0]
data remove storage call_stack: this.tagged_items[0]
data remove storage call_stack: this.return_items[0]
...
#>return
execute if data storage call_stack: {this:{nonempty:false}} run data modify storage call_stack: this.return.unslotted set from storage call_stack: this.return_items
execute if data storage call_stack: {this:{nonempty:false}} run data modify storage call_stack: this.return.slotted set from storage call_stack: this.slotted_items
#>recurs
