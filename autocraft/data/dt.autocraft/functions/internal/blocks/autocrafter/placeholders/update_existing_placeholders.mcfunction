...
execute if data storage call_stack: this.items[0] run data modify storage call_stack: this.pretagged_items set from storage call_stack: call.result[0]
execute if data storage call_stack: this.items[0] run data modify storage call_stack: this.untagged_items set from storage call_stack: call.result[1]
...
execute if data storage call_stack: this.items[0] run data modify storage call_stack: this.pretagged_items set from storage call_stack: call.result
...
execute if data storage call_stack: this.items[0] run function dt.array_util:api/concat
