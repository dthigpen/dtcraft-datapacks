...
execute if data storage call_stack: this.items[0] run data modify storage call_stack: call.arg0 set from storage call_stack: call.result[1]
execute if data storage call_stack: this.items[0] run function dt.autocraft:internal/blocks/autocrafter/placeholders/set_items_for_block_or_entity
