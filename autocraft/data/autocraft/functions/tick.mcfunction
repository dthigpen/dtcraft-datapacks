...
execute as @a[scores={dt.ac.placed=1..}] run function autocraft:internal/raycast/cast
...
execute as @e[tag=dt.ac] at @s run function autocraft:internal/blocks/autocrafter/tick


execute as @e[type=item,nbt={Item:{id:"minecraft:dropper",tag:{dt_autocrafter:1b}}}] at @s run function autocraft:internal/blocks/floor_craft/search_nearby