...
execute if data storage call_stack: {this:{can_craft:true}} run data modify storage call_stack: this.recipes set from storage call_stack: call.result.recipes
