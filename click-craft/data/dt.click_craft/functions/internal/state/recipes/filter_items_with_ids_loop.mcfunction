...
execute unless data storage call_stack: this.continue run data modify storage call_stack: this.return set from storage call_stack: this.filtered_items
...
execute if data storage call_stack: this.continue run data modify storage call_stack: this.matches set from storage call_stack: call.return[0]
execute if data storage call_stack: this.continue run data modify storage call_stack: this.non_matches set from storage call_stack: call.return[1]
...
execute if data storage call_stack: this.continue run function dt.click_craft:internal/state/recipes/filter_items_with_ids_loop
