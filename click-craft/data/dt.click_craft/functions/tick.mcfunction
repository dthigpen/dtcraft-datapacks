...
execute as @a if score @s dt.cc.tmp = #inventory dt.craft.state run function dt.click_craft:internal/state/inventory/set
execute as @a if score @s dt.cc.tmp = #inventory_reset dt.craft.state run function dt.click_craft:internal/state/inventory/reset
execute as @a if score @s dt.cc.tmp = #recipes dt.craft.state run function dt.click_craft:internal/state/recipes/set
scoreboard players reset @a dt.cc.tmp
scoreboard players enable @a dt.cc.tmp


# Handle an item selection for each state
execute as @a[scores={dt.cc.select=1..}] run function dt.click_craft:internal/state/handle_selection
