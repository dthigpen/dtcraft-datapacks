...
# turn temp item ids into positional array
data modify storage call_stack: this.return set value [[ [],[],[]],[[],[],[] ]]
#[[[cog
#   for i in range(0,9):
#       cog.outl(f'data modify storage call_stack: this.return[0][{i // 3}] append from storage call_stack: this.item_ids[{i}]')
#       cog.outl(f'data modify storage call_stack: this.return[1][{i // 3}] append from storage call_stack: this.temp_items[{i}].Count')
#       
#]]]
data modify storage call_stack: this.return[0][0] append from storage call_stack: this.item_ids[0]
data modify storage call_stack: this.return[1][0] append from storage call_stack: this.temp_items[0].Count
data modify storage call_stack: this.return[0][0] append from storage call_stack: this.item_ids[1]
data modify storage call_stack: this.return[1][0] append from storage call_stack: this.temp_items[1].Count
data modify storage call_stack: this.return[0][0] append from storage call_stack: this.item_ids[2]
data modify storage call_stack: this.return[1][0] append from storage call_stack: this.temp_items[2].Count
data modify storage call_stack: this.return[0][1] append from storage call_stack: this.item_ids[3]
data modify storage call_stack: this.return[1][1] append from storage call_stack: this.temp_items[3].Count
data modify storage call_stack: this.return[0][1] append from storage call_stack: this.item_ids[4]
data modify storage call_stack: this.return[1][1] append from storage call_stack: this.temp_items[4].Count
data modify storage call_stack: this.return[0][1] append from storage call_stack: this.item_ids[5]
data modify storage call_stack: this.return[1][1] append from storage call_stack: this.temp_items[5].Count
data modify storage call_stack: this.return[0][2] append from storage call_stack: this.item_ids[6]
data modify storage call_stack: this.return[1][2] append from storage call_stack: this.temp_items[6].Count
data modify storage call_stack: this.return[0][2] append from storage call_stack: this.item_ids[7]
data modify storage call_stack: this.return[1][2] append from storage call_stack: this.temp_items[7].Count
data modify storage call_stack: this.return[0][2] append from storage call_stack: this.item_ids[8]
data modify storage call_stack: this.return[1][2] append from storage call_stack: this.temp_items[8].Count
#[[[end]]]
