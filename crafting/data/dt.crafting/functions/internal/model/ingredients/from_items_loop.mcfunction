...
data modify storage call_stack: this.item_info.count set from storage call_stack: call.result
...
data modify storage call_stack: this.item_info.slots set from storage call_stack: call.result
