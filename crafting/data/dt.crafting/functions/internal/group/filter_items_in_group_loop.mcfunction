...
data modify storage call_stack: this.matches set from storage call_stack: call.return[0]
...
data modify storage call_stack: this.return set from storage call_stack: this.filtered
