...
execute if data storage call_stack: call.return[0] run data modify storage call_stack: this.fail_early set value true
...
execute if data storage call_stack: {this:{fail_early:false}} run function dt.array:api/difference
execute if data storage call_stack: {this:{fail_early:false}} run data modify storage call_stack: this.new_slots append from storage call_stack: call.return
...
data modify storage call_stack: this.return set from storage call_stack: this.new_slots
...
execute if data storage call_stack: this.tag_slots[0] run function dt.crafting:internal/recipe/resolve_tags_slots_loop
execute if data storage call_stack: this.tag_slots[0] run data modify storage call_stack: this.return set from storage call_stack: call.return
