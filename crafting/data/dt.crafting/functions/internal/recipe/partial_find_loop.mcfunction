...
data modify storage call_stack: this.remaining_item_ids set from storage call_stack: call.return
...
execute if data storage call_stack: this.recipe_tags[0] if data storage call_stack: this.remaining_item_ids[0] run data modify storage call_stack: this.remaining_item_ids set from storage call_stack: call.return
...
execute unless data storage call_stack: this.recipes[0] run data modify storage call_stack: this.return set from storage call_stack: this.matches
...
execute if data storage call_stack: this.recipes[0] run data modify storage call_stack: this.return set from storage call_stack: call.return
