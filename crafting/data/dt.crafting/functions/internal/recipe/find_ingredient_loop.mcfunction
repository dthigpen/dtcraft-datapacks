...
execute if data storage call_stack: {this:{fail_early:false}} if data storage call_stack: this.item_counts[0] if data storage call_stack: this.ingredients[0] run function dt.crafting:internal/recipe/find_ingredient_loop
