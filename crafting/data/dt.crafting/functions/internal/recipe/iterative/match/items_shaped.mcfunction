...
execute store result score #size1 dt.tmp run data get storage call_stack: this.item_rows
...
execute unless data storage call_stack: this.fail if data storage call_stack: this.item_rows[0] if data storage call_stack: this.set_rows[0] run data modify storage call_stack: call.arg2 set from storage call_stack: this.set_rows[0]
execute unless data storage call_stack: this.fail if data storage call_stack: this.item_rows[0] if data storage call_stack: this.set_rows[0] run function dt.array:api/split/in_set3
execute unless data storage call_stack: this.fail if data storage call_stack: this.item_rows[0] if data storage call_stack: this.set_rows[0] if data storage call_stack: call.return[1][0] run data modify storage call_stack: this.fail set value true

# row 2
execute unless data storage call_stack: this.fail if data storage call_stack: this.item_rows[1] if data storage call_stack: this.set_rows[1] run data modify storage call_stack: call.arg0 set from storage call_stack: this.item_rows[1]
execute unless data storage call_stack: this.fail if data storage call_stack: this.item_rows[1] if data storage call_stack: this.set_rows[1] run data modify storage call_stack: call.arg1 set from storage call_stack: this.item_rows[1]
execute unless data storage call_stack: this.fail if data storage call_stack: this.item_rows[1] if data storage call_stack: this.set_rows[1] run data modify storage call_stack: call.arg2 set from storage call_stack: this.set_rows[1]
...
execute unless data storage call_stack: this.fail if data storage call_stack: this.item_rows[2] if data storage call_stack: this.set_rows[2] run function dt.array:api/split/in_set3
