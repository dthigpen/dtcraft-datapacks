...
#       cog.outl(f'execute store success score #slot{slot} dt.slots3 run data get storage call_stack: this.compressed_item_ids[0][{count}]');
#       count += 1
#   cog.outl()
#   for slot in [1,2,3,10,11,12,19,20,21]:
...
execute store success score #slot10 dt.slots3 run data get storage call_stack: this.compressed_item_ids[0][3]
execute store success score #slot11 dt.slots3 run data get storage call_stack: this.compressed_item_ids[0][4]
execute store success score #slot12 dt.slots3 run data get storage call_stack: this.compressed_item_ids[0][5]
execute store success score #slot19 dt.slots3 run data get storage call_stack: this.compressed_item_ids[0][6]
execute store success score #slot20 dt.slots3 run data get storage call_stack: this.compressed_item_ids[0][7]
execute store success score #slot21 dt.slots3 run data get storage call_stack: this.compressed_item_ids[0][8]
