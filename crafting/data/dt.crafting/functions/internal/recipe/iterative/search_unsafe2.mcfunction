...
execute if data storage call_stack: this.is_shaped run function dt.crafting:internal/recipe/iterative/slots/get_shaped_slots3
execute if data storage call_stack: this.is_shaped run function dt.crafting:internal/recipe/iterative/slots/compare_shaped
...
execute if data storage call_stack: this.is_shaped if data storage call_stack: this.slots_match run function dt.crafting:internal/recipe/iterative/match/items_shaped
...
# execute if data storage call_stack: this.is_shaped if data storage call_stack: this.slots_match run tellraw @p ["search_unsafe2 global.dt.compressed_item_ids_shaped: ",{"nbt":"global.dt.compressed_item_ids_shaped","storage":"call_stack:"}]
# execute if data storage call_stack: this.is_shaped if data storage call_stack: this.slots_match run tellraw @p ["search_unsafe2 this.recipes[-1].items: ",{"nbt":"this.recipes[-1].items","storage":"call_stack:"}]
# execute if data storage call_stack: this.is_shapeless run tellraw @p ["search_unsafe2 this.recipes[-1]: ",{"nbt":"this.recipes[-1]","storage":"call_stack:"}]
...
execute if data storage call_stack: this.is_shapeless run function dt.crafting:internal/recipe/iterative/match/items_shapeless
...
execute unless data storage call_stack: global.dt.crafting.result if data storage call_stack: this.recipes[-1] run function dt.crafting:internal/recipe/iterative/search_unsafe2
