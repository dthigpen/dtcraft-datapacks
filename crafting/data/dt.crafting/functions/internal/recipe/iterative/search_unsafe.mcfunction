...
execute if score #shapeless dt.crafting.tmp matches 1 run data modify storage call_stack: call.arg0 set from storage call_stack: global.dt.recipes[-1].items
execute if score #shapeless dt.crafting.tmp matches 1 run tellraw @p ["search_unsafe call.arg0: ",{"nbt":"call.arg0","storage":"call_stack:"}]
execute if score #shapeless dt.crafting.tmp matches 1 run function dt.crafting:internal/recipe/iterative/slots/get_shapeless_slots3
execute if score #shapeless dt.crafting.tmp matches 1 run function dt.crafting:internal/recipe/iterative/slots/compare_shapeless
...
execute if score #slots_match dt.crafting.tmp matches 1 run function dt.crafting:internal/recipe/iterative/match/items
