...
execute if data storage call_stack: this.tags[0] if data storage call_stack: this.item_counts[0] run data modify storage call_stack: this.return set from storage call_stack: call.return
