...
execute if score $id dt.tmp matches 0 run function dt.crafting:internal/recipe/shaped/search_tree/24_0_ing2_start
execute if score $id dt.tmp matches 24 run function dt.crafting:internal/recipe/shaped/search_tree/24_24_ing2_start
execute if score $id dt.tmp matches 729 run function dt.crafting:internal/recipe/shaped/search_tree/24_729_ing2_start
...
execute if score $id dt.tmp matches -999999 run data modify storage call_stack: global.dt.recipes append value [613, 1]
