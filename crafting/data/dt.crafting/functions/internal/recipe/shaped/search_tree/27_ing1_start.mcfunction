...
execute if score $id dt.tmp matches 0 run function dt.crafting:internal/recipe/shaped/search_tree/27_0_ing2_start
execute if score $id dt.tmp matches 27 run function dt.crafting:internal/recipe/shaped/search_tree/27_27_ing2_start
execute if score $id dt.tmp matches 729 run function dt.crafting:internal/recipe/shaped/search_tree/27_729_ing2_start
...
execute if score $id dt.tmp matches -999999 run data modify storage call_stack: global.dt.recipes append value [616, 1]
