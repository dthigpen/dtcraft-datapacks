...
execute unless data storage call_stack: this.group_names[0] run data modify storage call_stack: this.return set from storage call_stack: this.remaining_item_ids
...
execute if data storage call_stack: this.group_names[0] run data modify storage call_stack: this.return set from storage call_stack: call.return
