...
data modify storage call_stack: this.matching_groups set from storage call_stack: call.return[0]
...
data modify storage call_stack: this.items_in_group set from storage call_stack: call.return
...
execute if data storage call_stack: this.items_in_group[0] run data modify storage call_stack: this.tags[0] set from storage call_stack: call.return.tag
...
execute unless data storage call_stack: this.item_counts[0] if score int1 dt.tmp matches 0 if data storage call_stack: this.matching_groups[0] unless data storage call_stack: this.tags[0] run data modify storage call_stack: this.return set value true
...
execute if data storage call_stack: this.item_counts[0] if data storage call_stack: this.matching_groups[0] if data storage call_stack: this.tags[0] if data storage call_stack: this.item_counts[0] run function dt.crafting:internal/recipe/resolve_tags_item_loop
execute if data storage call_stack: this.item_counts[0] if data storage call_stack: this.matching_groups[0] if data storage call_stack: this.tags[0] if data storage call_stack: this.item_counts[0] run data modify storage call_stack: this.return set from storage call_stack: call.return
