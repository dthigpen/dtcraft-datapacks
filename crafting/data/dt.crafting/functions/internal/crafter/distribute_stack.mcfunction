...
# setup return value
data modify storage call_stack: this.return.free_slots set from storage call_stack: this.arg1
data modify storage call_stack: this.return.new_items set value []

execute store result score int1 dt.tmp run data get storage call_stack: this.item.Count
execute store result score size1 dt.tmp run data get storage call_stack: this.return.free_slots
...
execute if score flag dt.tmp matches 1 store result storage call_stack: this.template_item.Slot byte 1 run data get storage call_stack: this.return.free_slots[0]
execute if score flag dt.tmp matches 1 run data modify storage call_stack: this.return.new_items append from storage call_stack: this.template_item
execute if score flag dt.tmp matches 1 run scoreboard players remove int1 dt.tmp 1
execute if score flag dt.tmp matches 1 run data remove storage call_stack: this.return.free_slots[0]
...
execute if score int1 dt.tmp matches 1.. run data modify storage call_stack: this.return.new_items prepend from storage call_stack: this.item
