...
data modify storage call_stack: this.expected set from storage dt.crafting: recipes[{return:{id:"minecraft:stone_hoe"}}]
...
data modify storage call_stack: this.expected set value {}
data modify storage call_stack: this.expected set from storage dt.crafting: recipes[{return:{id:"minecraft:book"}}]
