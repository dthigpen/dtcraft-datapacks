...
data modify storage call_stack: this.expected set from storage dt.crafting: recipes[{return:{id:"minecraft:anvil"}}]
...
data modify storage call_stack: this.expected set value {}
data modify storage call_stack: this.expected set from storage dt.crafting: recipes[{return:{id:"minecraft:beetroot_soup"}}]
