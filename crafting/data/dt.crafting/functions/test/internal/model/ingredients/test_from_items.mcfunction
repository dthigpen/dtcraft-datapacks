...
data modify storage call_stack: call.expected set value {grid:[ [[0,684,0],[0,729,0],[0,0,0]],[[0b,1b,0b],[0b,1b,0b],[0b,0b,0b]] ],items:{crafting:[{Count:1b,Slot:2b,id:"minecraft:coal"},{Count:1b,Slot:11b,id:"minecraft:stick"}],extras:[{Count:1b,Slot:4b,id:"minecraft:feather"}]}}
