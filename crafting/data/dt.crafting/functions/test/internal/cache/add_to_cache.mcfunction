...
data modify storage call_stack: this.test_name set value "update_cache_full"
...
function call_stack:push
data modify storage call_stack: this.test_name set value "update_cache_partial"
...
function call_stack:push
data modify storage call_stack: this.test_name set value "update_cache_empty"
