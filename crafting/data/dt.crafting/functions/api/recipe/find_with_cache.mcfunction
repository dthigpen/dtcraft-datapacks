...
execute unless data storage call_stack: this.is_same_as_last if data storage call_stack: this.entity_crafting_data.cache.good_recipes[0] run data modify storage call_stack: this.recipe_result set from storage call_stack: call.return
...
execute if data storage call_stack: this.not_in_good_recipes run data modify storage call_stack: this.info_obj set from storage call_stack: call.return
...
execute if data storage call_stack: this.not_in_good_recipes if data storage call_stack: call.return[0][0] run data modify storage call_stack: this.in_bad_items set value true
...
execute if data storage call_stack: this.not_in_good_recipes unless data storage call_stack: this.in_bad_items run data modify storage call_stack: this.recipe_result set from storage call_stack: call.return
...
execute if data storage call_stack: this.in_all_recipes run data modify storage call_stack: this.entity_crafting_data.cache.good_recipes set from storage call_stack: call.return
...
execute if data storage call_stack: this.not_in_all_recipes run data modify storage call_stack: this.entity_crafting_data.cache.bad_items set from storage call_stack: call.return
...
data modify storage call_stack: this.return set from storage call_stack: this.recipe_result
...
# tellraw @p ["find_with_cache.mcfunction: RESULT: ",{"nbt":"this.return.result.id","storage":"call_stack:"}]
