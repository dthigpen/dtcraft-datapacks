...
data modify storage call_stack: this.options set value {}
...
execute if data storage call_stack: this.valid_count run data modify storage call_stack: call.arg1 set from storage call_stack: this.options
