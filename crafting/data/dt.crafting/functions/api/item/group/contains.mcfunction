...
data modify storage call_stack: this.result set value true
execute if data storage call_stack: {this:{index:-1}} run data modify storage call_stack: this.result set value false
