...
execute if data storage call_stack: this.compressed_item_ids[1] run data modify storage call_stack: global.dt.item_ids append value -2
data modify storage call_stack: global.dt.item_ids append from storage call_stack: this.compressed_item_ids[1][]
execute if data storage call_stack: this.compressed_item_ids[2] run data modify storage call_stack: global.dt.item_ids append value -2
