...
data modify storage dtcraft:call_stack this.items set from storage dtcraft:call_stack this.call.result
...
data modify storage dtcraft:call_stack this.item_found set from storage dtcraft:call_stack this.call.result
