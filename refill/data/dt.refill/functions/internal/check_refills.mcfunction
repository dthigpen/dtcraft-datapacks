...
execute unless data entity @s SelectedItem if data storage call_stack: this.user.data.selected run data modify storage call_stack: this.user set from storage call_stack: call.return
...
data modify storage dt.refill: users set from storage call_stack: call.return
