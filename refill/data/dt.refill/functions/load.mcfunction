...
execute unless score $dt.user_util load.status matches 1 run tellraw @p ["",{"text":"Error: ","color":"dark_red"},{"text":"Refill","bold":true}," requires ",{"text":"user-util ","bold":true},"0.1"]
scoreboard players set $dt.tmp.dep load.status 0
execute if score $dt.user_util.version.major load.status matches 0 if score $dt.user_util.version.minor load.status matches 1.. run scoreboard players set $dt.tmp.dep load.status 1
execute if score $dt.user_util load.status matches 1 unless score $dt.tmp.dep load.status matches 1 run tellraw @p ["",{"text":"Error: ","color":"dark_red"},{"text":"Refill","bold":true}," expected ",{"text":"user-util ","bold":true},"0.1"," but found ",{"score":{"name":"$dt.user_util.version.major","objective":"load.status"}},".",{"score":{"name":"$dt.user_util.version.minor","objective":"load.status"}}]
...
execute unless score $dt.array load.status matches 1 run tellraw @p ["",{"text":"Error: ","color":"dark_red"},{"text":"Refill","bold":true}," requires ",{"text":"Array ","bold":true},"0.1"]
scoreboard players set $dt.tmp.dep load.status 0
...
execute unless score $dt.inventory load.status matches 1 run tellraw @p ["",{"text":"Error: ","color":"dark_red"},{"text":"Refill","bold":true}," requires ",{"text":"Inventory ","bold":true},"0.1"]
scoreboard players set $dt.tmp.dep load.status 0
